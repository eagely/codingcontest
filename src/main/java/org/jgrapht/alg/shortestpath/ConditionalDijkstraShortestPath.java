 ...
 * @author John V. Sichi
 */
public final class ConditionalDijkstraShortestPath<V, E> extends BaseShortestPathAlgorithm<V, E> {
     ...
     */
    public ConditionalDijkstraShortestPath(Graph<V, E> graph, Condition<E> condition) {
        this(graph, Double.POSITIVE_INFINITY, PairingHeap::new, condition);
    }
     ...
     */
    public ConditionalDijkstraShortestPath(Graph<V, E> graph, double radius, Condition<E> condition) {
        this(graph, radius, PairingHeap::new, condition);
    }
     ...
     */
    public ConditionalDijkstraShortestPath(Graph<V, E> graph, Supplier<AddressableHeap<Double, Pair<V, E>>> heapSupplier, Condition<E> condition) {
        this(graph, Double.POSITIVE_INFINITY, heapSupplier, condition);
    }
     ...
     * @param heapSupplier supplier of the preferable heap implementation
     */
    public ConditionalDijkstraShortestPath(Graph<V, E> graph, double radius, Supplier<AddressableHeap<Double, Pair<V, E>>> heapSupplier, Condition<E> condition) {
        super(graph);
        if (radius < 0.0) {
     ...
     */
    public static <V, E> GraphPath<V, E> findPathBetween(Graph<V, E> graph, V source, V sink, Condition<E> condition) {
        return new ConditionalDijkstraShortestPath<>(graph, condition).getPath(source, sink);
    }
    ...
    public GraphPath<V, E> getPath(V source, V sink)
    {
        ...
        ConditionalDijkstraClosestFirstIterator<V, E> it = new ConditionalDijkstraClosestFirstIterator<>(graph, source, radius, heapSupplier, condition);
