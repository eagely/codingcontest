 ...
 */
class ConditionalDijkstraClosestFirstIterator<V, E> implements Iterator<V> {
     ...
     */
    public ConditionalDijkstraClosestFirstIterator(Graph<V, E> graph, V source, Condition<E> condition)
    {
        this(graph, source, Double.POSITIVE_INFINITY, PairingHeap::new, condition);
    }
     ...
     */
    public ConditionalDijkstraClosestFirstIterator(Graph<V, E> graph, V source, double radius, Condition<E> condition)
    {
        this(graph, source, radius, PairingHeap::new, condition);
    }
     ...
     */
    public ConditionalDijkstraClosestFirstIterator(
            Graph<V, E> graph, V source, Supplier<AddressableHeap<Double, Pair<V, E>>> heapSupplier, Condition<E> condition)
    {
        this(graph, source, Double.POSITIVE_INFINITY, heapSupplier, condition);
    }
     ...
     * @param heapSupplier supplier of the preferable heap implementation
     */
    public ConditionalDijkstraClosestFirstIterator(Graph<V, E> graph, V source, double radius, Supplier<AddressableHeap<Double, Pair<V, E>>> heapSupplier, Condition<E> condition) {
    ...
    public V next()
    {
        ...
        // relax edges
        for (E e : graph.outgoingEdgesOf(v).stream().filter( e -> condition.test(e, getDistanceAndPredecessorMap().get(v).getFirst())).toList()) {
